...
for w in $windows; do
	for dr in $datasets; do
		python3 compare_measures.py --dataset $dr  --strategy no_weight --strategy pmi_1990 --strategy pmi_1990_all --strategy freq --strategy freq_all --window $w --emb_dim 100
	done
done
