...
def read_args():
    ...
    parser.add_argument('--strategy', type=str, choices=["no_weight", "pmi_2019", "normalized_pmi", "pmi_1990", "dice", "llr", "llr_all", "chi_square"], help='representation method', required=True)
