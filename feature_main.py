...
def read_args():
    ...
    parser.add_argument('--strategy', type=str, choices=["no_weight", "pmi_2019", "normalized_pmi", "pmi_1989"], help='representation method', required=True)
